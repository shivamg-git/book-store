...
int main()
{
    ...
    case 2:
        ...
        cout<<"\t<<| Enter details |>>\n";
            ...
            initialize();
			cout <<"\n\tEnter the book or author for which you wish to search for:\n";
			cout <<"\t>>";
    ...
    default:
        /// can put exceptional handling their...
        cout << "\n\t\t$$ Wrong Choice\n";
        goto XX;
    }
